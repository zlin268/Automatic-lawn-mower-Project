/**
 * This file contains the implementation of the Monitor and all associated member functions.
 * This class is used to control the monitor, using it we display the status and users use it to visually see the length/width of the lawn as they change it
 * 
 */
...
/**
 * Function that can be used to draw a single pixel
 * @param x: the x coord of the pixel
 * @param y: the y coord of the pixel
 * @param color: the color we want for the pixel
 */
...
/**
 * Function that initializes the monitor
 * @param vccstate: used in wiringPi
 * @param i2caddr: used in wiringPi
 */
// Init SSD1306
...
/**
 * Function that can invert the display
 */
...
/**
 * Function used for scrolling, to the right
 */
...
/**
 * Function used for scrolling, to the left
 */
...
/**
 * Function used for scrolling, diag right
 */
...
/**
 * Function used for scrolling, diag left
 */
...
/**
 * Function used to stop the scroll
 */
...
/**
 * Function used for dimming display
 */
...
// clear everything
/**
 * Function used for clearing the dislpay memory
 */
...
/**
 * Function used for drawing fast horizontal lines (internally)
 */
...
/**
 * Function used for drawing fast vertical lines (internally)
 */
...
/**
 * Function used for drawing fast horizontal lines
 */
...
/**
 * Function used for drawing fast vertical lines
 */
...
/**
 * Function used for filling a rectangle
 */
...
/**
 * Function used for setting the text size
 */
...
/**
 * Function used for writting to the screen
 */
...
/**
 * Function used for drawing strings
 */
...
/**
 * Function used for drawing individual characters
 */
